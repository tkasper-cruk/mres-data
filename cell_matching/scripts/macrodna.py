###ADAPTED FROM https://github.com/NakhlehLab/MaCroDNA
### Modifications
#### - allow custom gurobipy env to be used
import numpy as np
...
class MaCroDNA:
    def __init__(self, rna_df=None, dna_df=None, dna_label=None,gp_env=None):
        # INPUT
        ...
        # gp_env -- custom gurobipy environment
        self.rna_df = rna_df
        self.dna_df = dna_df
    ...
    def ilp(self, rna_idx, dna_idx, corrs):
        ...
        if self.gp_env is None:
            m = gp.Model("Pearson_GRB")
        else:
            m = gp.Model("Pearson_GRB",env=self.gp_env)
