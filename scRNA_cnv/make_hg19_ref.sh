...
#SBATCH -p 
#SBATCH -o /Users/kasper01/logs/%x_%J.log
#SBATCH -e /Users/kasper01/logs/%x_%J.log
...
fasta_url="https://ftp.ensembl.org/pub/grch37/release-113/fasta/homo_sapiens/dna/Homo_sapiens.GRCh37.dna.primary_assembly.fa.gz"
...
gtf_in="${source}/gencode.v19.primary_assembly.annotation.gtf"
...
cellranger mkref --ref-version="$version" --genome="$genome" --fasta="$fasta_modified" --genes="$gtf_filtered" --localmem=30000 --localcores=8
